        ...
        <Card>
            ...
            <Grid container spacing={6}>
              <Grid item xs={12} md={6}>
                <Box sx={{ mb: 4 }}>
                  ...
                  <Typography variant='body'>A simple start for everyone</Typography>
                </Box>
                <Box sx={{ mb: 4 }}>
                  <Typography sx={{ fontWeight: 500, mb: 1, fontSize: '0.875rem' }}>
                    Active until Dec 09, 2021
                  </Typography>
                  <Typography variant='body'>We will send you a notification upon Subscription expiration</Typography>
                </Box>
                <div>
                  ...
                  <Typography variant='body'>Standard plan for small to medium businesses</Typography>
                </div>
              </Grid>
              ...
              <Grid item xs={12} md={6} sx={{ mt: [4, 4, 0] }}>
                ...
                <Typography variant='body' sx={{ mt: 2, mb: 4 }}>
          ...
          >
            ...
            <DialogContent sx={{ px: theme => [`${theme.spacing(5)} !important`, `${theme.spacing(15)} !important`] }}>
              <DialogContentText variant='body' sx={{ textAlign: 'center' }} id='user-view-plans-description'>
      ...
      <Grid item xs={12}>
        <Card>
          ...
          >
            ...
            >
              <DialogContentText variant='body' id='user-address-edit-description' sx={{ textAlign: 'center', mb: 7 }}>
